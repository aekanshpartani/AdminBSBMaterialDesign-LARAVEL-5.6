...
@section('extra-scripts')
    ...
    <!-- Ckeditor -->
    <script src="{{ URL::asset('bsb/plugins/ckeditor/ckeditor.js')}}"></script>

    <!-- TinyMCE -->
    <script src="{{ URL::asset('bsb/plugins/tinymce/tinymce.js')}}"></script>

    <!-- Custom Js -->
    <script src="{{ URL::asset('bsb/js/pages/forms/editors.js')}}"></script>
