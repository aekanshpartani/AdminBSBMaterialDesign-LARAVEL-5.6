...
@section('title', 'Forms - Advanced Form Elements')

@section('extra-css')


    <!-- Colorpicker Css -->
    <link href="{{ URL::asset('bsb/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.css')}}" rel="stylesheet" />

    <!-- Dropzone Css -->
    <link href="{{ URL::asset('bsb/plugins/dropzone/dropzone.css')}}" rel="stylesheet" />

    <!-- Multi Select Css -->
    <link href="{{ URL::asset('bsb/plugins/multi-select/css/multi-select.css')}}" rel="stylesheet" />

    <!-- Bootstrap Spinner Css -->
    <link href="{{ URL::asset('bsb/plugins/jquery-spinner/css/bootstrap-spinner.css')}}" rel="stylesheet" />

    <!-- Bootstrap Tagsinput Css -->
    <link href="{{ URL::asset('bsb/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css')}}" rel="stylesheet" />

    <!-- Bootstrap Select Css -->
    <link href="{{ URL::asset('bsb/plugins/bootstrap-select/css/bootstrap-select.css')}}" rel="stylesheet" />

    <!-- noUISlider Css -->
    <link href="{{ URL::asset('bsb/plugins/nouislider/nouislider.min.css')}}" rel="stylesheet" />
...
@section('extra-scripts')
    ...
    <script src="{{ URL::asset('bsb/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js')}}"></script>

    <!-- Dropzone Plugin Js -->
    <script src="{{ URL::asset('bsb/plugins/dropzone/dropzone.js')}}"></script>
    <script src="../../"></script>

    <!-- Input Mask Plugin Js -->
    <script src="{{ URL::asset('bsb/plugins/jquery-inputmask/jquery.inputmask.bundle.js')}}"></script>

    <!-- Multi Select Plugin Js -->
    <script src="{{ URL::asset('bsb/plugins/multi-select/js/jquery.multi-select.js')}}"></script>

    <!-- Jquery Spinner Plugin Js -->
    <script src="{{ URL::asset('bsb/plugins/jquery-spinner/js/jquery.spinner.js')}}"></script>

    <!-- Bootstrap Tags Input Plugin Js -->
    <script src="{{ URL::asset('bsb/plugins/bootstrap-tagsinput/bootstrap-tagsinput.js')}}"></script>

    <!-- noUISlider Plugin Js -->
    <script src="{{ URL::asset('bsb/plugins/nouislider/nouislider.js')}}"></script>

    <!-- Custom Js -->
    <script src="{{ URL::asset('bsb/js/pages/forms/advanced-form-elements.js')}}"></script>
