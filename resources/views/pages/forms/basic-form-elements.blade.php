...
@section('title', 'Forms - Basic Form Elements')

@section('extra-css')
    <!-- Bootstrap Material Datetime Picker Css -->
    <link href="{{ URL::asset('bsb/plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css')}}" rel="stylesheet" />
...
@section('extra-scripts')
    ...
    <script src="{{ URL::asset('bsb/plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js')}}"></script>
